                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            @foreach($barangs as $p)
                                                <form class="form-horizontal" role="form" action="data/update" method="post">                                              
                                                    {{ csrf_field() }}
                                                    <input type="hidden" name="id" value="{{ $p->id }}">
                                                    <div class="form-group row">
                                                        <label class="control-label">Ruang Barang</label>
                                                        <div class="col-10">
                                                            <input type="text" id="ruang" name="ruang" class="form-control" value="{{$p->ruang}}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="control-label" for="example-email">NIP Pegawai</label>
                                                        <div class="col-10">
                                                            <input type="text" id="nip_pegawai" name="nip_pegawai" class="form-control" value="{{$p->nip_pegawai}}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Tipe Barang</label>
                                                        <div class="col-10">
                                                            <select class="form-control" name="tipe" value="{{$p->tipe}}" required>
                                                                <option>Spray</option>
                                                                <option>Baju Pasien</option>
                                                                <option>---</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="date" name="tanggal_penyerahan" value="{{$p->tanggal_penyerahan}}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
