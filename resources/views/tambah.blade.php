                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-20">
                                                <form class="form-horizontal" role="form" action="tambah/laundry" method="post">
                                                {{ csrf_field() }}   
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Ruang Barang</label>
                                                        <div class="col-10">
                                                            <input type="text" id="ruang" name="ruang" class="form-control" placeholder="Ruang..." required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">NIP Pegawai</label>
                                                        <div class="col-10">
                                                            <input type="text" id="nip_pegawai" name="nip_pegawai" class="form-control" placeholder="Nip Pegawai" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Tipe Barang</label>
                                                        <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Tanggal Penyerahan</label>
                                                        <div class="col-10">
                                                            <input class="form-control" type="date" name="tanggal_penyerahan" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
